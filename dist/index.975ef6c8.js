...
var _project1 = require("./scripts/project1");
var _project1Default = parcelHelpers.interopDefault(_project1);
var _project2 = require("./scripts/project2");
var _project2Default = parcelHelpers.interopDefault(_project2);
...
(0, _project1Default.default)();
(0, _project2Default.default)();

},{"./scripts/scrollReveal":"54rka","./scripts/tiltAnimation":"72kAb","./scripts/project1":"iAkUs","./scripts/project2":"lWgM4","./data/scrollRevealConfig":"5aORV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"54rka":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"iAkUs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function projectcard1() {
    ...
    dots.forEach((dot, idx)=>{
        ...
        dot.addEventListener("click", (e)=>{
            ...
            if (clickedDotNum == activeDotNum) // console.log('active');
            return;
            else {
...
exports.default = projectcard1;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lWgM4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function projectcard2() {
    ...
    dots1.forEach((dot1, idx1)=>{
        ...
        dot1.addEventListener("click", (e)=>{
            ...
            // console.log(clickedDotNum);
            //     if the dot clicked is already active, then do nothing
            if (clickedDotNum1 == activeDotNum1) // console.log('active');
            return;
            else {
                // console.log('not active');
                // shift the wrapper
